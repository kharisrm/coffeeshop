        ...
        <?php 
			...
			<div class="main-content">
                ...
                <div class="reviews_stat">
                 ...
                 <input type="hidden" id="hidden-year" value="<?php echo isset($values[2]) ? $values[2] : ''; ?>" />
...
<!--##################################################################################### 
        when the admin click on star button
        a popup modal appears -> let the admin view all reviews
    ##################################################################################### -->
...
<!--##################################################################################### 
        when the admin click on status button
        a popup modal appears -> let the admin view shop status
    ##################################################################################### -->
