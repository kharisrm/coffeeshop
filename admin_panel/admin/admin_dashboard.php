        ...
        <?php 
			...
			<div class="main-content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="card-title">RP<?php echo $row['nb'] ?></h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                ...
                ?>
                    ...
                    <label class="col-sm-3 col-md-4 control-label">Delivery cost: <span id="cost"><?php echo $row['delivery_cost']; ?> </span>RP </label>     
                    <input type="button" id="delivery" value="change delivery cost" />

                </div>

                <hr />
                <h4>Currency (from RP)</h4>
				<hr />
