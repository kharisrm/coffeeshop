...
<body>
    ...
    <?php
    // if we don't have an empty cart
        ...
        <div class="cart">
            ...
            <div class="table-responsive" id="order_table">
                <table class="table table-bordered table-stripped">
                    ...
                    // loop through the shopping cart to display the items
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="toppings_list">
                                <?php
                                // if the client didn't select any toppings
                                if ($values['product_toppings'] == '')
                                    echo "No Toppings Selected";
                                else {
                                    // loop through the toppings list and fetch the toppings image and price
                                ...
                                <?php
                                        ...
                                        // calculate the total price of all toppings added in the shopping cart for quantity=1
                                ...
                                // save the price of all toppings added in the shopping cart
                                ...
                                // save the total of each item in the shopping cart
