<section class="offers" id="offers">  
    <div class="category">
            <?php for($i=1; $i<7; $i++){ ?>
                    <a href="#" class="cat">
                        <img src="images/flash/0<?php echo $i ?>.jpg" alt="">
                    </a>
            <?php } ?>
    </div>  
    ...
    <h1 class="heading" data-aos="fade-up"> and order now! </h1>
    ...
    <div class="banner">
        ...
        <div class="grid-banner">
            ...
            <div class="grid" data-aos="fade-up">
                <img src="images/flash/01.jpg" alt="">
                <div class="content">
            ...
            <div class="grid" data-aos="fade-up">
                <img src="images/flash/02.jpg" alt="">
                <div class="content">
